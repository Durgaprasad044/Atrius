...
CREATE TABLE "Stats" (
    ...
    "smartMatches" INTEGER NOT NULL DEFAULT 0,
    "eventsAttended" INTEGER NOT NULL DEFAULT 0,
    "postsShared" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "Stats_profileId_key" ON "Stats"("profileId");
...
-- AddForeignKey
ALTER TABLE "Stats" ADD CONSTRAINT "Stats_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
